...
public class HttpsRequest extends Request {
  ...
  public HttpsRequest(InetSocketAddress addr,
                      ByteBuffer[] request,
      ...
      switch (hs) {
        ...
        case NEED_UNWRAP:
          ...
          if (read < 0) {
            ...
            peerNetData.compact();
            switch (res.getStatus()) {
              case BUFFER_OVERFLOW: // Not possible, peerAppData
                // is 64k
                break;
              case CLOSED:
                return -1;
            ...
            // do not flip to write here, since TCP buffer is
            // writable
          }
          break;
        case NEED_WRAP:
