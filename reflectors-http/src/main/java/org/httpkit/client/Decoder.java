...
import static org.httpkit.HttpUtils.findWhitespace;
import static org.httpkit.HttpUtils.getChunkSize;
...
import static org.httpkit.client.State.READ_CHUNKED_CONTENT;
import static org.httpkit.client.State.READ_CHUNK_DELIMITER;
import static org.httpkit.client.State.READ_CHUNK_FOOTER;
import static org.httpkit.client.State.READ_CHUNK_SIZE;
import static org.httpkit.client.State.READ_FIXED_LENGTH_CONTENT;
import static org.httpkit.client.State.READ_HEADER;
import static org.httpkit.client.State.READ_INITIAL;
import static org.httpkit.client.State.READ_VARIABLE_LENGTH_CONTENT;
...
public class Decoder {
    ...
    private void parseInitialLine(String sb) throws ProtocolException, AbortException {
        ...
        if ((cStart < cEnd)
                // Account for buggy web servers that omit Reason-Phrase from
                // Status-Line.
