...
public class Request implements Comparable<Request> {
    ...
    boolean isReuseConn = false; // a reused socket
    // sent the
    // request
    ...
    // close
    // connection
    private long timeoutTs;          // future time
    // this request
    // timeout, ms

    public Request(InetSocketAddress addr, ByteBuffer[] request, IRespListener handler, PriorityQueue<Request> clients, RequestConfig config) {
        this.cfg = config;
